...
import { DEFAULT_TAB_GROUP_SETTINGS, TAB_GROUP_SETTINGS } from './tab-group-settings.token';
...
@Component({
  ...
  providers: [createSettingsProvider<EntireTabGroupSettings>('anglifyTabGroupSettings', DEFAULT_TAB_GROUP_SETTINGS, TAB_GROUP_SETTINGS)],
})
