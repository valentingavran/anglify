...
import { DEFAULT_SLIDER_SETTINGS, SLIDER_SETTINGS } from './slider.token';
import { createSettingsProvider } from '../../factories/settings.factory';
import { bindClassToNativeElement, toBoolean } from '../../utils/functions';
import { BooleanLike } from '../../utils/interfaces';
import { TooltipDirective } from '../tooltip/tooltip.directive';
import { TooltipSettings } from '../tooltip/tooltip.interface';
...
export class SliderComponent implements ControlValueAccessor, AfterViewInit {
  ...
  @Input() public ticks: BooleanLike = this.settings.ticks;
  ...
  public ticksArray$ = this.step$.pipe(map(step => new Array<number>(this.max / step + 1)));
