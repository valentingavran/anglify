import { ButtonModule, IconModule, ListModule, NavDrawerModule } from '@anglify/components';
...
@NgModule({
  imports: [CommonModule, NavDrawerModule, ButtonModule, ListModule, IconModule],
